...
export default function KeysPage(){
  ...
  return (
    <div style={{maxWidth:720, margin:"24px auto"}}>
      ...
      <div style={{border:"1px solid #333", padding:16, borderRadius:8, marginTop:12}}>
      ...
      <form onSubmit={save} style={{border:"1px solid #333", padding:16, borderRadius:8, marginTop:16, display:"grid", gridTemplateColumns:"160px 1fr", gap:8}}>
        <label>환경</label>
